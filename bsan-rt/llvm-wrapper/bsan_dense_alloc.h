...
// This is a port of ThreadSanitizer's `DenseSlabAlloc`. It shares many
// of the properties and much of the code from the original design. It's a
// freelist-based allocator of fixed-size objects with a global, atomic free
...
// Segments are also aligned to powers of two, by construction.
